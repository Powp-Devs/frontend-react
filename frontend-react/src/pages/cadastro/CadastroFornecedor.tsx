  ...
  return (
    ...
    <div className="app-container">
      ...
      <main className="main-content">
        ...
        <div className="content-header" style={{ padding: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div className="actions" style={{ display: 'flex', gap: '10px' }}>
            ...
            <button className="btn btn-primary" onClick={openNewSupplierModal}>
            ...
            <table className="suppliers-table">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <SortableHeader label="Cod. Fornec" column="id" currentSort={sortConfig} onSort={handleSort} />

                  <SortableHeader label="Fornecedor" column="name" currentSort={sortConfig} onSort={handleSort} />

                  <SortableHeader label="E-MAIL" column="email" currentSort={sortConfig} onSort={handleSort} />

                  <SortableHeader label="Data de cadastro" column="date" currentSort={sortConfig} onSort={handleSort} />
              ...
              <tbody>
                ...
                {filteredSuppliers.map(supplier => (
                  ...
                  <tr key={supplier.id}>
                    ...
                    <td>
                      ...
                      <button className="action-btn edit-btn" onClick={() => openEditModal(supplier)}>
                    ...
                    <td>
                      ...
                      <button className="action-btn delete-btn" onClick={() => confirmDelete(supplier.id)}>
                ...
                {filteredSuppliers.length === 0 && (
                  ...
                  <tr>
                    ...
                    <td colSpan={7} style={{ textAlign: 'center', padding: '20px' }}>Nenhum fornecedor encontrado</td>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group-row">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" name="cnpj" value={formData.cnpj} onChange={handleFormChange} />
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" name="fantasyName" value={formData.fantasyName} onChange={handleFormChange} />
                ...
                <div className="form-group-row">
                  ...
                  <div className="form-group cep-group">
                    ...
                    <input type="text" name="cep" value={formData.cep} onChange={handleFormChange} />
                  ...
                  <div className="form-group numero-group">
                    ...
                    <input type="text" name="number" value={formData.number} onChange={handleFormChange} />
                ...
                <div className="form-group-row">
                   ...
                   <div className="form-group">
                    ...
                    <input type="text" name="neighborhood" value={formData.neighborhood} onChange={handleFormChange} />
                  ...
                  <div className="form-group estado-group">
                    ...
                    <input type="text" name="state" value={formData.state} onChange={handleFormChange} maxLength={2} />
                ...
                <div className="form-group-row">
                  ...
                  <div className="form-group">
                   ...
                   <div className="form-group">
                    ...
                    <input type="tel" name="mobile" value={formData.mobile} onChange={handleFormChange} />
